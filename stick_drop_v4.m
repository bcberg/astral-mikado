...
alpha = 8e-4;    % aspect ratio alpha = r/l in (1e-4, 1e-2)
l = r/alpha;    % stick length becomes r/alpha
L = 5e-5/l0;   % region 100um x 100um
Nstick = 1.25e3;
...
% figure(1)
% hold on
% plot(nodes(:,1), nodes(:,2), 'ro', boundaryNodes(:,1), boundaryNodes(:,2), 'gs')
% hold off
...
springCatalog = springsByNode(springs, size(nodes,1));
save('smalltestNetwork_1.25e3stick.mat')
