 ...
 *
 * generateAstralNetwork_emxutil.c
 *
...
{
  emxFree_real_T(sp, &pStruct->nodes);
  emxFree_real_T(sp, &pStruct->augNodes);
  emxFree_real_T(sp, &pStruct->springs);
  emxFree_real_T(sp, &pStruct->ends);
}

void emxFreeStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct)
{
  emxFree_real_T(sp, &pStruct->centerCross);
  emxFree_real_T(sp, &pStruct->filCross);
}

void emxFreeStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct)
{
  emxFree_real_T(sp, &pStruct->centers);
  emxFree_real_T(sp, &pStruct->orients);
}
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->nodes, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->augNodes, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->springs, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->ends, 2, srcLocation);
}

void emxInitStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->centerCross, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->filCross, 2, srcLocation);
}

void emxInitStruct_struct2_T(const emlrtStack *sp, struct2_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->centers, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->orients, 2, srcLocation);
}
...
/* End of code generation (generateAstralNetwork_emxutil.c) */
